...
function M.set_keybindings()
        ...
        awful.key({ M.modkey }, "equal",
                  function ()
                      ...
                      for _, cli in ipairs(tag:clients()) do
                          if cli.minimized == true then
                              cli.minimized = false
                              client.focus = cli
                              break
                          end
...
function M.set_client_keybindings()
    ...
    awful.key({ M.modkey }, "minus", -- the counterpart to it is in normal bindings
              function (c)           -- under the equal key, reopens minimized windows
                  c.minimized = true
              end,
              {
                  "minimize client",
    ...
    awful.key({ M.modkey }, "s",
              function (c) -- sticky clients dont occupy taskbar
                if c.sticky then
                    c.sticky = false
    ...
    awful.key({ M.modkey }, "f",
              function(c) -- floating clients always centered and on top
                if c.floating then
                    c.floating = false
                    c.on_top = false
                else
